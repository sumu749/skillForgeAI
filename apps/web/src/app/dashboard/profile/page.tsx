...
export default function ProfilePage() {
  const { data } = useQuery({
    queryKey: ["my-courses"],
    queryFn: async () => {
      const res = await api.get("/courses", { params: { limit: 3, sort: "popular" } });
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {isClerkEnabled ? (
              ...
              <>
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Email</p>
                  <p className="font-medium">demo@skillforge.ai</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Role</p>
                ...
                <div>
                  ...
                  <p className="font-medium text-sm">Configure Clerk keys for real auth</p>
                </div>
              </>
            )}
          </div>

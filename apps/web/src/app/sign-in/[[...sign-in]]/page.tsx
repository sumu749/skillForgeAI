    ...
    return (
      <div className="container flex flex-col items-center justify-center min-h-[70vh] py-12 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-md">
          Add your Clerk keys to <code className="text-sm">apps/web/.env.local</code> to enable authentication.
          You can still use the dashboard and AI tutor without signing in during development.
        </p>
        <Link href="/dashboard">
